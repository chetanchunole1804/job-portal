...
export default function NavBar() {
    ...
    return (
        <>
            <div className={`w-full ${scrolled ? "bg-teal-600/70" : "bg-teal-600"} px-6 h-20 bg-teal-600 text-white flex items-center justify-between fixed top-0 left-0 z-50`}>
                ...
                <div className='px-2 h-full hidden items-center justify-center lg:flex'>
                    ...
                    <Link href={'/frontend/dashboard'} className="px-3 mx-4 text-base font-medium transition-all duration-700  uppercase" >Dashboard</Link>
                    <Link href={'/'} className="px-3 mx-4 text-base font-medium transition-all duration-700  uppercase" >Contact</Link>
                </div>
                <div className='px-2 h-full hidden items-center justify-center lg:flex ' >
                    {
                        user !== null ? (
                            ...
                            <>
                                <Link href={'/auth/login'} className='px-4 py-2 border border-white rounded uppercase tracking-widest mx-4   transition-all duration-700 hover:bg-white font-semibold text-base hover:text-teal-600'>Login</Link>
                                <Link href={'/auth/register'} className='px-4 py-2 border border-white rounded uppercase tracking-widest mx-4   text-teal-600 bg-white transition-all duration-700 hover:bg-transparent font-semibold text-base hover:text-white'>REGISTER</Link>
                            </>
                        )
                    }
                ...
                {
                    isOpen && (
                        <div ref={ref} className='flex w-full py-2 animate-fade-in-down  bg-teal-600 transition-all fade duration-1000 absolute top-20 left-0  items-center justify-center flex-col '>
